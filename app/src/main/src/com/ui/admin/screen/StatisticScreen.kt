...
import com.ui.admin.component.OverviewCard
import com.ui.admin.component.ProgressRow
...
fun StatisticScreen(
    ...
    Column(
        ...
        Row(
            ...
            // ĐÃ SỬA: Xóa bỏ tiền tố _root_ide_package_
            OverviewCard(
        ...
        uiState.topArticleModels.forEachIndexed { index, article ->
            Card(
                ...
                Row(modifier = Modifier.padding(16.dp), verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Column {
                        Text(article.title ?: "N/A", fontWeight = FontWeight.Bold)
                        Text("Tác giả: ${article.author ?: "N/A"}  •  👁 ${article.views} views", style = MaterialTheme.typography.bodySmall)
                    }
                }
            }
        }
